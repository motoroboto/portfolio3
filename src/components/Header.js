        ...
        <nav className={navigationToggler ? "mi-header is-visible" : "mi-header"}>
            ...
            <div className="mi-header-inner">
                <div className="mi-header-image">
                    <Link to="/">
                        <img src={information.brandImage}
                            placeholder='/images/about-image.jpg' alt="brandimage" />
                    </Link>
                </div>
                ...
                <p className="mi-header-copyright">&copy; {new Date().getFullYear()} <b><a rel="noopener noreferrer" target="_blank" href="https://github.com/motoroboto">Robert Cullen-Keel</a></b></p>
            </div>
        </nav>
    )
}
